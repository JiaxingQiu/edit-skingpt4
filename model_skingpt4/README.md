...
## Download LLMs and pull their weights

### step 1: pretrained weights are under /weights folder
...
### step 2: download LLMs and pull their weights
create a hf_models folder under model_skingpt4
